...
def convert_streamlit_state_to_profile() -> "ProfileSettings":
    ...
    post_retirement_settings = PostRetirementSettings(
        ...
        postret_isa_withdrawal_age=postret_isa_withdrawal_age,
        postret_isa_targeted_withdrawal_percentage=postret_isa_targeted_withdrawal_percentage,
        postret_lisa_withdrawal_age=postret_lisa_withdrawal_age,
        postret_lisa_targeted_withdrawal_percentage=postret_lisa_targeted_withdrawal_percentage,
